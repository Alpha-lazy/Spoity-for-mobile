      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }} onClick={()=>{navigate(`/artist/${songData.artists.primary[0].id}`)}}>
              <svg
                style={{ width: "24px", height: "24px", fill: "white" }}
                data-enco
                re-id="icon"
        ...
        <footer
          onClick={() => {
            document.getElementById("song-more-Info").style.display = "none";
          }}
          style={{
            width: "100%",
            textAlign: "center",
