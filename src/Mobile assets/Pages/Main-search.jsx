 ...
 console.log(responce.data.data);
  ...
  return (
      ...
      >
        ...
        >
          ...
          {serchResult?.topQuery?.results.length > 0 ? (
            <div style={{ width: "100%", display: "flex", gap: "5px" ,overflow:"scroll",flexWrap:"nowrap"}}>
              <NavLink
    ...
    >
                ...
                {/*  playlist */}
                {serchResult?.playlists?.results.map((data) => {
                  return (
                    <div
                      className="albums_row"
                ...
                {/*  artist */}
                {serchResult?.artists?.results.map((data) => {
                  return (
                    <div
                      className="albums_row"
                      style={{
